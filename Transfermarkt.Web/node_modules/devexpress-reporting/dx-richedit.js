                ...
                (function (RichEdit) {
                    ...
                    (function (Internal) {
                                ...
                                if (newRtfString === undefined) {
                                    var openSaveAction = function () {
                                        _this.richEdit.openDocument(btoa(_this.surface._control.name()), DevExpress.RichEdit.DocumentFormat.PlainText, function () {
                                            ...
                                            _this.richEdit.setDefaultFont(_this.fontModel.family.peek(), _this.fontModel.size.peek());
                        ...
                        var XRRichEditControlModel = (function (_super) {
                            ...
                            XRRichEditControlModel.prototype.getDefaultFont = function () {
                                return this._richEdit.document.getDefaultCharacterProperties();
                            };
                            XRRichEditControlModel.prototype.setDefaultFont = function (fontName, size) {
                                var props = this.getDefaultFont();
                                props.fontName = fontName;
                                props.size = size;
                                this._richEdit.document.setDefaultCharacterProperties(props);
                            };
